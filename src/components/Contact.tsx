...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-primary-50 to-warm-50 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
                ...
                <div className="space-y-2">
                  {workingHours.map((schedule, index) => (
                    <div key={index} className="flex justify-between items-center">
                      ...
                      <span className="font-medium text-gray-800 dark:text-white">{schedule.time}</span>
                    </div>
                  ))}
                </div>
              </div>
